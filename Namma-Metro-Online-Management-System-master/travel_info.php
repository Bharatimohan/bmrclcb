...
<div class = "demo-content">
    <form class="form-horizontal" method="POST" action="train_details_page.php">
      <div class="form-group">
        <label class="control-label col-xs-2"><strong>Route</strong></label>
        <div class="col-xs-10">
      ...
      <div class="form-group">
        <label class="control-label col-xs-2"><strong>From</strong></label>
        <div class="col-xs-10">
      ...
      <div class="form-group">
        <label class="control-label col-xs-2"><strong>To</strong></label>
        <div class="col-xs-10">
